...
\begin{document}
	...
	In this report, a detailed analysis of the real LIBS dat, provided by the LSA, is presented. The study begins with the visualization of the spectra and an examination of their intrinsic properties, including peak intensities and corresponding wavelengths. They are also compared with the spectra generated using the NIST LIBS tool. Following this comparative analysis, general considerations for employing these spectra in training machine learning (ML) algorithms for steel grade classification are discussed. The report concludes with a set of open questions and points for clarification that need to be addressed.
