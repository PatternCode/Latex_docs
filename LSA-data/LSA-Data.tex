...
\begin{document}
	...
	In this report, a detailed analysis of the LIBS (Laser-Induced Breakdown Spectroscopy) spectra for the real material provided by the LSA is presented. The study begins with the visualization of the spectra and an examination of their intrinsic properties, including peak intensities and corresponding wavelengths. In the next step, they are compared with reference spectra generated using the NIST LIBS Synthetic Spectra Tool to evaluate consistency and identify characteristic emission lines of relevant elements. Following this comparative analysis, general considerations for employing these spectra in training machine learning (ML) algorithms for steel grade classification are discussed. The report concludes with a set of open questions and points for clarification that need to be addressed in order to guide the next phase of the project.
